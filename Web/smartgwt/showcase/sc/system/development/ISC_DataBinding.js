...
for(var i=0;i<_4.operations.length;i++){if(_4.operations[i].clientOnly)continue;_20+=_4.operations[i].data}
_20+="</operations>";_20+="</transaction>"}else{_20="{ \"transaction\": { \"transactionNum\": "+_4.transactionNum+", ";_20+="\"operations\": [";for(var i=0;i<_4.operations.length;i++){if(_4.operations[i].clientOnly)continue;if(i>0)_20+=", ";_20+=_4.operations[i].data}
...
if(_16.results&&!_6.isRestRequest){isc.addProperties(_16,_16.results)}}
