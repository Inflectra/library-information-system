...
/*
  ...
  Version SC_SNAPSHOT-2012-03-06_v8.2p/LGPL Development Only (2012-03-06)
...
,isc.A.selectList=function isc_Selection_selectList(_1,_2){if(_2==null)_2=true;if(!_1)return false;this.cacheSelection();var _3=this.$925;this.$925=true;var _4=false,_5=_1.getLength();for(var i=0;i<_5;i++){var _7=_1.get(i);if(this.isSelected(_7)==_2)continue;_4=this.setSelected(_7,_2)||_4}
this.$925=_3;this.cacheSelection();return _4}
...
this.invokeSuper(isc.GridBody,"redraw",_1,_2,_3,_4);delete this.$58p;if(_7){if(_12!=null&&_12.length>0){_6.removeItems(_12)}
...
var _3=this.getSort();if(_3)this.setSort(_3);if(isc.ResultSet&&isc.isA.ResultSet(this.data)&&this.body&&this.body.overflow=="visible")
...
);isc.evalBoundary;isc.B.push(isc.A.hideField=function isc_ListGrid_hideField(_1,_2){arguments.$cw=this;var _3=true,_4=true;if(!isc.isAn.Array(_1)){_1=[_1]}
...
,isc.A.getPrintFooters=function isc_ListGrid_getPrintFooters(_1,_2){if(this.summaryRow&&this.summaryRow.body&&this.showGridSummary){var _3={startRow:0,endRow:this.summaryRow.getTotalRows(),maxRows:this.summaryRow.printMaxRows,printProps:this.printProperties||{},html:[]}
...
);isc.evalBoundary;isc.B.push(isc.A.$338=function isc_ListGrid__unsortOnChange(_1,_2){var _3=this.$60z();if(_3==null)return;var _4=this.fields[_3];if(_4==null)return;var _5=_4[this.fieldIdProperty];var _6;if(_5!=null&&_1[_5]!==_6&&(_2==null||_1[_5]!=_2[_5]))
{this.unsort()}}
...
,isc.A.sort=function isc_ListGrid_sort(_1,_2){if(isc.isA.String(_1))_1=this.getFieldNum(_1);var _3=this.$60z(),_4=(_3!=null?Array.shouldSortAscending(this.getField(_3).sortDirection):null);if(_1==null){if(_3!=null){_1=_3}else{for(var i=0;i<this.fields.length;i++){if(this.$91k(this.fields[i])!=false){_1=i;break}}}}
if(_1==null)return false;var _6=this.getField(_1);if(_6==null){return}
if(_2==null){_2=this.$766(_6)}
...
var _23=this.groupTree.getRoot(),_24=0,_25=0,_26=this.groupTree,_2=this.getGroupByFields();while(_23!=null&&_25<_2.length){var _27=_26.getChildren(_23);var _28=(this.completeFields||this.fields).find(this.fieldIdProperty,_2[_25]);for(var i=0;i<_27.length;i++){var _29=_27[i],_30=this.getGroupTitle(_29,_28);if(!this.singleCellGroupHeaders()){_29.groupTitle=_30}else _29[this.singleCellValueProperty]=_30;if(this.showGroupSummary&&this.showGroupSummaryInHeader){this.applyGroupSummaryToHeader(_29)}}
